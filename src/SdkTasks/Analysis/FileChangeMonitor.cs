...
namespace SdkTasks.Analysis
{
    ...
    public class FileChangeMonitor : Microsoft.Build.Utilities.Task, IMultiThreadableTask
    {
        ...
        public override bool Execute()
        {
            ...
            ReportResults(collectedChanges.Count);
            return true;
        }
        ...
        private void ReportResults(int totalChanges)
        {
