// DirectPathResolver - Resolves paths and reads environment configuration
using System;
using System.IO;
...
namespace SdkTasks.Build
{
    ...
    public class DirectPathResolver : Microsoft.Build.Utilities.Task, IMultiThreadableTask
    {
